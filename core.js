...
function createMessageFragment(msg, prevMsg, nextMsg, lastSenderRef) {
    ...
    if (isRedPacket) {
        ...
        if (isVoiceMedia) {
            content += `<div class="chat-media-message chat-media-audio" data-media-id="${msg.id}" onclick="window.playChatVoiceBubble && window.playChatVoiceBubble(this,event)">
            ...
            content += `<div class="chat-media-message chat-media-video chat-video-direct-card" data-media-id="${msg.id}" onclick="window.playChatVideoBubble && window.playChatVideoBubble(this,event)">
